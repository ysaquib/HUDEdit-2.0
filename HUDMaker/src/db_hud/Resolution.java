...
public class Resolution extends Dialog {
	...
	private static void createContents() {
		...
		combo_ratio.setItems(new String[] { "4:3", "5:3", "5:4", "16:9", "16:10", "21:9" });
		...
		combo_ratio.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent e) {
				...
				} else if (combo_ratio.getText().equals("21:9")) {
					combo_res.setEnabled(true);
					combo_res.setItems(
							new String[] { "2560 x 1080", "3440 x 1440", "5120 x 2160", "10240 x 4320" });
				} else {
					combo_res.setEnabled(false);
				}
			}
		...
		btnOkay.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent e) {
				...
				//21:9 Resolution
				else if (combo_res.getText().equals("2560 x 1080")) {
					HUD_Maker.compX = 2560;
					HUD_Maker.compY = 1080;
					Settings.resRatio = 219;
				} else if (combo_res.getText().equals("3440 x 1440")) {
					HUD_Maker.compX = 3440;
					HUD_Maker.compY = 1440;
					Settings.resRatio = 219;
				} else if (combo_res.getText().equals("5120 x 2160")) {
					HUD_Maker.compX = 5120;
					HUD_Maker.compY = 2160;
					Settings.resRatio = 219;
				} else if (combo_res.getText().equals("10240 x 4320")) {
					HUD_Maker.compX = 10240;
					HUD_Maker.compY = 4320;
					Settings.resRatio = 219;
				}
				
				//"2560 x 1080", "3440 x 1440", "5120 x 2160", "10240 x 4320"
